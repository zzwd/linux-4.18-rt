...
ifneq "$(CC_VERSION_TEXT)" "aarch64-linux-gcc.br_real (Buildroot 2018.11-dirty) 7.3.0"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "/home/zzw/project/pine64_rt/buildroot/output/host/bin/aarch64-linux-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(SRCARCH)" "arm64"
include/config/auto.conf: FORCE
